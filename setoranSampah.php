  ...
  <hr class="bg-danger fw-bold fixed-top" style="height: 13px; margin: top 15px;">
    ...
    <div class="container-newsletter">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <h3 class="title-un">TOP 10 PENYETOR SAMPAH</h3>
                  <div class="title-un-icon"><i class="fas fa-book"></i></div>
                  <p class="title-un-des" style="text-align: center;">Berikut adalah rincian dari penyetor sampah terbanyak</p>
                    <table id="example" class="display" cellspacing="0" width="100%" border="0" >
                      ...
                      <?php $kode = $row["idUser"] ?>
                      <?php $idUser = query("SELECT idUser FROM users WHERE idUser = '$kode' "); ?>
